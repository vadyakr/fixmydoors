import { version, unref, inject, defineAsyncComponent, defineComponent, provide, shallowReactive, h, ref, watch, Suspense, nextTick, Transition, useSSRContext, createApp, effectScope, reactive, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, hasInjectionContext, getCurrentInstance, toRef, mergeProps, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw } from 'vue';
